...
Run from project root:
    ...
    Custom:
    python run.py --steps 200 --cats 10 --prey 50 --width 30 --height 30 --pb 0.2 --seed 123
"""
...
def main():
    ...
    parser.add_argument("--pf", type=float, default=0.4, help="prey_flee_prob")
